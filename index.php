...
<div id="mainWrapper">
  <header> 
    ...
    <div id="logo"> <!-- <img src="logoImage.png" alt="sample logo"> --> 
      <!-- Company Logo text --> 
      LOGO </div>
    <div id="headerLinks"><a href="./login.html" title="Login/Register">Login/Register</a><a href="#" title="Cart">Cart</a></div>
  </header>
  <section id="offer"> 
      ...
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <?php
          ...
          while ($c < 3)
          {
            ...
            echo '<div><img alt="sample" src="../../../../../../Applications/XAMPP/xamppfiles/htdocs/emailPHP/eCommerceAssets/images/200x200.png"></div>';
            echo '<p class="price">$50</p>';
            echo '<p class="productContent">Content holder </p>';
